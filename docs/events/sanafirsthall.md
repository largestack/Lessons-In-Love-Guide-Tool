...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=sanafirsthall&go=Go)



## Event preconditions
✅Event "[Sana: Family Business](./firsttimebar.md)" is completed (event=firsttimebar)
