# Dorm War II: Pre-Game Show (Main)
...
* Chain sources: dormwartwo1
* Chain sources path: dormwartwo1

## Official wiki page

[Dorm War II: Pre-Game Show](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=dormwartwo2&go=Go) for more details.
