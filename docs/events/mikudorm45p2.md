...
* Chain sources: mikudorm45
* Chain sources path: mikudorm45

## Official wiki page

[Chrysalis](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=mikudorm45p2&go=Go) for more details.
