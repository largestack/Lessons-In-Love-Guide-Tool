...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=makiinvite2&go=Go)



## Event preconditions
✅Event "[Maki: Traveling Lube Dealer](./makiinvite1.md)" is completed (event=makiinvite1)
