...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=chinamidate5&go=Go)
...
✅Event "[Chinami: 5,000 Year-Old Wizard](./chinamidate1.md)" is completed (event=chinamidate1)
