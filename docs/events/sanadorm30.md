# Tortoises and the Concept of Friendship (Sana)
...
* Event [Self-Medication](./bar30.md) (Sana) is completed)
...
* Triggered by path: sanadorm->sanadorm30

## Official wiki page

[Tortoises and the Concept of Friendship](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=sanadorm30&go=Go) for more details.
