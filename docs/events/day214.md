...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=day214&go=Go)
...
✅Event "[Maki: Maki Miyamura's Mom-Mode Mission](./makidate5.md)" is completed (event=makidate5)
...
✅Event "[Ami: Everlasting Love](./amidorm25.md)" is completed (event=amidorm25)
