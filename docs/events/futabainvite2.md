...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=futabainvite2&go=Go)



## Event preconditions
✅Event "[Futaba: Sonnet 18](./futabainvite1.md)" is completed (event=futabainvite1)
