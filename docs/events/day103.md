...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=day103&go=Go)
...
✅Event "[Main: Rewrite](./day102.md)" is completed (event=day102)
