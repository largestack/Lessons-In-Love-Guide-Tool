...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=day240&go=Go)
...
✅Event "[Main: A Door that People Move Through](./day239.md)" is completed (event=day239)
