...
* Event [A Tree Falls in the Forest](./futabadorm30.md) (Futaba) is completed)
...
* Triggered by path: library->library35

## Official wiki page

[No, You](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=library35&go=Go) for more details.
