...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=dojo25&go=Go)
...
✅Event "[Ayane: Still Young](./ayanedorm20.md)" is completed (event=ayanedorm20)



## Next events
* [Ayane: Cold Air of an Encroaching Winter](./ayanedorm25.md)
