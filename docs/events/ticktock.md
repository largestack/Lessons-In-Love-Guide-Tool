# Tick Tock Tick Tock Tick Tock (Happy scenes)
...
* Triggered by path: doorknock->ticktock

## Official wiki page

[Tick Tock Tick Tock Tick Tock](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=ticktock&go=Go) for more details.
