...
* Event [The Retail Machine](./firsttimemall.md) (Chika) is completed)

* Event [A Dog that Does Math](./chikafirsthall.md) (Chika) is completed)
...
* Triggered by path: chikadorm->chikadorm5

## Official wiki page

[Something About Biting](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=chikadorm5&go=Go) for more details.
