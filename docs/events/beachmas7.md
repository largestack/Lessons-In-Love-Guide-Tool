...
Part of event chain [No Cumming on Christmas](./beachmas6.md)
...
* Id: beachmas7
* Group: Main
* Triggered by label: beachmas6
* Chain sources: beachmas6
* Chain sources path: beachmas6

## Official wiki page

[Fetch Quest](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=beachmas7&go=Go) for more details.
