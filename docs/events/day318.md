...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=day318&go=Go)
...
✅Event "[Miku: Speed of Light](./mikudorm40.md)" is completed (event=mikudorm40)

✅Event "[Molly: Ahead of the Curve](./mollydorm20.md)" is completed (event=mollydorm20)

✅Event "[Otoha: Highly Pornographic](./otohadorm5.md)" is completed (event=otohadorm5)
