...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=rinspecial55&go=Go)


Part of event chain [Metronome In Love](./rikaspecial1.md)
...
* ID: rinspecial55
* Group: Rin
* Triggered by label: rikaspecial1
