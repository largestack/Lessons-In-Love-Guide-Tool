# Mysterious Abundance of Chickens (Main)
...
* Chain sources: halloween3
* Chain sources path: halloween3

## Official wiki page

[Mysterious Abundance of Chickens](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=halloween4&go=Go) for more details.
