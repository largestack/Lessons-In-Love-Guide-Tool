...
* Triggered by path: saturdaymorning->harukacafe->harukafirstlust

## Official wiki page

[The Need to be Hurt](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=harukafirstlust&go=Go) for more details.
