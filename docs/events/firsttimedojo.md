# The Unwavering Bravery of Ayane Amamiya (Ayane)
...
* Ayane love greater than or equal to 0



## Next events

* [Main: Operation: Fallen Angel](./day16.md)
...
* Triggered by path: dojo->firsttimedojo

## Official wiki page

[The Unwavering Bravery of Ayane Amamiya](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=firsttimedojo&go=Go) for more details.
