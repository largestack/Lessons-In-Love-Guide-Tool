...
* Event [Cold Air of an Encroaching Winter](./ayanedorm25.md) (Ayane) is completed)
...
* Triggered by path: dojo->dojo30

## Official wiki page

[First and Second](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=dojo30&go=Go) for more details.
