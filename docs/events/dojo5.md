...
* Triggered by path: dojo->dojo5

## Official wiki page

[The Battle for Kumon-mi](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=dojo5&go=Go) for more details.
