...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=iodorm25&go=Go)
...
❌Event "[Io: Work Less, Not Hard](./bathhouse25.md)" is completed (event=bathhouse25)
