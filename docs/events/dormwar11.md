# The Legacy of Thaum Pt. Z: Alentha Amastacia (Main)
...
Part of event chain [In Some Cases, Love](./dormwar10.md)
...
* Id: dormwar11
* Group: Main
* Triggered by label: dormwar10
* Chain sources: dormwar10
* Chain sources path: dormwar10

## Official wiki page

[The Legacy of Thaum Pt. Z: Alentha Amastacia](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=dormwar11&go=Go) for more details.
