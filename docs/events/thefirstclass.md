...
* Chain sources: firstfriday
* Chain sources path: firstfriday->firstfriday->firstfridayx

## Official wiki page

[First  Day of School](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=thefirstclass&go=Go) for more details.
