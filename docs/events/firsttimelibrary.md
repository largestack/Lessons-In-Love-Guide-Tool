...
* Triggered by path: library->firsttimelibrary

## Official wiki page

[Impossible Blossoms](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=firsttimelibrary&go=Go) for more details.
