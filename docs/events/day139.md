...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=day139&go=Go)
...
✅Event "[Chika: True Power: Unleashed](./mall20.md)" is completed (event=mall20)
