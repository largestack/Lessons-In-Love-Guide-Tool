...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=beachmas14&go=Go)


Part of event chain [The Legacy of Thaum Pt. IV](./beachmas13.md)
...
label beachmas14:
    ...
    n "Niki’s hairbrush was way too big for that sort of thing. I used a marker, like real {i}distinguished{/i} lady."
    ...
    sa "..."
    ay "You {i}didn’t.{/i}"
    mi "Didn’t what? The heck’s goin’ on over here? And how come Sana looks like she just caught with her pants-"
