...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=library25&go=Go)
...
✅Event "[Futaba: Only Child](./library20.md)" is completed (event=library20)
