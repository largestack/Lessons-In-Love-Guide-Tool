...
* Triggered by path: inviteover->makiinvite->makiinvite1

## Official wiki page

[Traveling Lube Dealer](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=makiinvite1&go=Go) for more details.
