...
[Official event wiki page](https://lessonsinlove.wiki/index.php?title=Special%3ASearch&search=ayanesanabeach4&go=Go)


Part of event chain [It Comes to Claim Us All](./ayanesanabeach3.md)
...
* ID: ayanesanabeach4
* Group: Sana
* Triggered by label: ayanesanabeach3
